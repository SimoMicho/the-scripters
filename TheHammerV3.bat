...
mode 1000
color a
echo Are you sure you want to run THE_HAMMER? (respond with yes to run application)
set /p love=
if %love%==yes goto hate
:hate
echo You Have Chosen To Run THE_HAMMER.
timeout 10
)
@echo off
color a
...
echo     @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@$$##########@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
timeout 30
echo HA. HA. HA. HAHAHAHHAHAHAHA.
reg add "HKEY_CURRENT_USER\Control Panel\Desktop" /v Wallpaper /t REG_SZ /d c:\584acf56f9777273048b87db.png /f
...
echo. 
echo ^<p^>LOLOLLOLOLOLLOLOLOLOLOOLOLOLOLOLOOLOLOLOL:^</p^> 
echo. 
echo ^<p^>VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.VANIXTYWASHERE.^</p^> 
echo. 
echo ^<p^>HAHAHHAHAHAHAHAHHAHAHAHAHAHHAHHAAHAHAHHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHAHA.^</p^> 
echo. 
echo ^<p^>Muahhahhahahahahhahahaha!^</p^> 
echo. 
